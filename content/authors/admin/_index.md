...
我的研究主要围绕两个领域：一是数字时代的议程设置效果。我使用混合数据科学研究方法，探索网络议程设置与媒介间议程设置效果，旨在探索传统媒介与新兴传播技术在对社会议题与相关属性议程的建构上存在何种互惠机制，勾勒出议程设置效果在不同维度上的强度与议程流动的方向性，进一步挖掘和探佚议程建构的文化性、社会性、组织性和个体性动因。这一研究议程部分成果已发表在Journalism，Journalism Studies，Journalism & Mass Communication Quarterly等SSCI新闻学顶尖期刊。我的第二个研究议程关涉媒介研究与健康研究的交叉点。我通过主要使用调查、实验等定量方法，探究不同的信源使用、信息接触行为、素养因素对健康观念、态度、行为与决策的影响，旨在出具提升风险意识和科学认知、促进科学决策的整体性策略。这一研究议程的部分成果已发表在New Media & Society，Journalism，Mass Communication & Society，Computers in Human Behavior等SSCI传播学与媒介研究顶尖期刊。自2019年以来，我的科研成果已获得多个学术奖项，包括6项AEJMC“最佳论文奖”等。
